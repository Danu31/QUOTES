...
function addQuotes(data) {
    ...
    for (let i = 0; i < thelask.length; i++){
        ...
        openQuote.setAttribute("src", "https://res.cloudinary.com/multimediarog/image/upload/v1659946687/IFrameApplication/open_voywbb.svg")
...
function BUTTON(){
    ...
    if(button.style.backgroundColor = "#1A73E8"){
